                    ...
                    <div class="box box-solid">
                        ...
                        <div class="box-footer">
                            <form id="searchForm" class="form-horizontal"
                                  action="${request.contextPath}/hbase/farm/command" method="get">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="type" class="col-md-2 col-lg-1 control-label">指令类型</label>
                                        <div class="col-md-10 col-lg-11">
                                            <select class="form-control" id="type" name="type">
                                                <option value="down" <#if type = 'down'>selected</#if>>下发指令</option>
                                                <option value="up" <#if type = 'up'>selected</#if>>一体机指令
                                                </option>
                                            </select>
                                        </div>
                                    </div>
...
<script>
    function showHideColumns() {
        if ($('#type').val() == 'down') {
            $('#columns').parent().parent().hide();
        } else {
            $('#columns').parent().parent().show();
        }
    }
