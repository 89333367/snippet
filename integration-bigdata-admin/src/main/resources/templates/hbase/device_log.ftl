                    ...
                    <div class="box box-solid">
                        ...
                        <div class="box-footer">
                            <form id="searchForm" class="form-horizontal"
                                  action="${request.contextPath}/hbase/device/log" method="get">
                                <div class="box-body">
                                ...
                                <div class="box-footer">
                                    ...
                                    <button id="btn_command" type="button" class="btn btn-danger pull-right">发送设备日志请求</button>
...
<script>
    ...
    $('#btn_command').click(function(){
        if($('#did').val() && $('#did').val().length > 0){
            $.post('${request.contextPath}/hbase/device/log/command',{did:$('#did').val()}
            ,function(result){
