                    ...
                    <div class="box box-solid">
                        ...
                        <div class="box-footer">
                            <form id="searchForm" class="form-horizontal"
                                  action="${request.contextPath}/hbase/interface" method="get">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="tokenId" class="col-md-2 col-lg-1 control-label">密钥</label>
                                        <div class="col-md-10 col-lg-11">
                                            <input class="form-control" id="tokenId" name="tokenId" placeholder="密钥"
                                                   required
                                                   value="${tokenId}">
                                        </div>
                                    </div>
    ...
    $(function () {
        UML.tablePlus({
            ...
            columns: [{
                data: 'startTime',
                title: '查询时间'
            }, {data: 'code', title: '响应状态'}, {
                data: 'executeTime',
                title: '执行时间'
            }, {data: 'methodName', title: '调用方法'}, {data: 'result', title: '结果'}],
