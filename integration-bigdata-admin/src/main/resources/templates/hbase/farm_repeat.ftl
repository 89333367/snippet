                    ...
                    <div class="box box-solid">
                        ...
                        <div class="box-footer">
                            <form id="searchForm" class="form-horizontal"
                                  action="${request.contextPath}/hbase/farm/repeat" method="get">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="type" class="col-md-2 col-lg-1 control-label">重复类型</label>
                                        <div class="col-md-10 col-lg-11">
                                            <select class="form-control" id="type" name="type">
                                                <option value="">全部</option>
                                                <option value="1" <#if type = '1'>selected</#if>>GPS时间重复，上报内容相同
                                                </option>
                                                <option value="2" <#if type = '2'>selected</#if>>GPS时间重复，上报内容不同
                                                </option>
                                            </select>
                                        </div>
                                    </div>
...
<script>
    $(function () {
        UML.tablePlus({
            el: 'resultTable',
            columns: [{data: '3014'}, {data: 'type'}, {data: 'totalRepeat'}],
