                    ...
                    <div class="box box-solid">
                        ...
                        <div class="box-footer">
                            <form id="searchForm" class="form-horizontal"
                                  action="${request.contextPath}/hbase/ne/can" method="get">
                                <div class="box-body">
...
<script>
    ...
    $(function () {
        UML.tablePlus({
            el: 'resultTable',
            columns: [{data: 'TIME'}, {data: '3014'}, {
                data: 'params3'
            }, {data: '2205'}, {
                data: '2601',
                render: function (value, row) {
                    if (value && value.indexOf('未') > -1) {
            ...
            exportTitle: '新能源Can数据',
            frozenLeft: $.isMobile == true ? 0 : 2,
            export: true,
            info: 'right'
        });
    });
