                    ...
                    <div class="box box-solid">
                        ...
                        <div class="box-footer">
                            <form id="searchForm" class="form-horizontal"
                                  action="${request.contextPath}/hbase/ne/packageCount" method="get">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10 col-lg-11">
                                            <input class="form-control" id="actualPackageNum"
                                                   name="actualPackageNum" placeholder="实际应发包数"
                                                   value="${actualPackageNum}" type="number" min="1">
                                        </div>
                                    </div>
                                </div>
                                <!-- /.box-body -->
