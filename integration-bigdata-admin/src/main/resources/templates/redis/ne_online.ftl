                    ...
                    <div class="box box-solid">
                        ...
                        <div class="box-footer">
                            <form id="searchForm" class="form-horizontal"
                                  action="${request.contextPath}/redis/ne/online" method="get">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="second" class="col-md-2 col-lg-1 control-label">上报时间</label>
                                        <div class="col-md-10 col-lg-11">
                                            <div class="input-group">
                                                <input class="form-control" id="second" name="second"
                                                       placeholder="上报时间" required value="${second}">
                                                <div class="input-group-addon" style="background-color: #eee;">
                                                    秒（该时间内设备最后一次上报数据全部信息）
                                                </div>
                                            </div>
                                        </div>
                                    </div>
